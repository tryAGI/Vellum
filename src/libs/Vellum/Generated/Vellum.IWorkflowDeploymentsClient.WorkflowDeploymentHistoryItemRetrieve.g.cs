...
namespace Vellum
{
    public partial interface IWorkflowDeploymentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.WorkflowDeploymentHistoryItem>> WorkflowDeploymentHistoryItemRetrieveAsResponseAsync(
            global::System.Guid historyIdOrReleaseTag,
            string id,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
