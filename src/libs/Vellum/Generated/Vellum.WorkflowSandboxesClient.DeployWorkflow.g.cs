...
namespace Vellum
{
    public partial class WorkflowSandboxesClient
    {
        ...
        {
            var __response = await DeployWorkflowAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.WorkflowDeploymentRead>> DeployWorkflowAsResponseAsync(
            global::System.Guid id,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeployWorkflowAsync",
                                pathTemplate: "$\"/v1/workflow-sandboxes/{id}/deploy\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
