...
namespace Vellum
{
    public partial class SubpackageDeploymentsClient
    {
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement s_RetrieveProviderPayloadSecurityRequirement0 =
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement[] s_RetrieveProviderPayloadSecurityRequirements =
            new global::Vellum.EndPointSecurityRequirement[]
            {                s_RetrieveProviderPayloadSecurityRequirement0,
            };
        partial void PrepareRetrieveProviderPayloadArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Vellum.DeploymentProviderPayloadRequest request);
        partial void PrepareRetrieveProviderPayloadRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Vellum.DeploymentProviderPayloadRequest request);
        partial void ProcessRetrieveProviderPayloadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetrieveProviderPayloadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vellum.DeploymentProviderPayloadResponse> RetrieveProviderPayloadAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveProviderPayloadArguments(
            ...
            var __authorizations = global::Vellum.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RetrieveProviderPayloadSecurityRequirements,
                operationName: "RetrieveProviderPayloadAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRetrieveProviderPayloadRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetrieveProviderPayload",
                                methodName: "RetrieveProviderPayloadAsync",
                                pathTemplate: "\"/v1/deployments/provider-payload\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetrieveProviderPayloadResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Vellum.ApiException<global::Vellum.ExecutePromptApiErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetrieveProviderPayloadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vellum.DeploymentProviderPayloadResponse> RetrieveProviderPayloadAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vellum.DeploymentProviderPayloadRequest
            {
            ...
            return await RetrieveProviderPayloadAsync(
                request: __request,
                requestOptions: requestOptions,
