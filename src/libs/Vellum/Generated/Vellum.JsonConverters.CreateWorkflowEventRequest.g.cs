...
{
    /// <inheritdoc />
    public class CreateWorkflowEventRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vellum.CreateWorkflowEventRequest>
    {
        /// <inheritdoc />
        public override global::Vellum.CreateWorkflowEventRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<global::Vellum.WorkflowEvent>), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Vellum.WorkflowEvent), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::System.Collections.Generic.IList<global::Vellum.WorkflowEvent>? createWorkflowEventRequest0 = default;
            global::Vellum.WorkflowEvent? workflowEvent = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        createWorkflowEventRequest0 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        workflowEvent = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (createWorkflowEventRequest0 == null && workflowEvent == null)
            {
                try
                {
            ...
            var __value = new global::Vellum.CreateWorkflowEventRequest(
        ...
        public override void Write(
            ...
            global::Vellum.CreateWorkflowEventRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsCreateWorkflowEventRequest0)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<global::Vellum.WorkflowEvent>), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::System.Collections.Generic.IList<global::Vellum.WorkflowEvent>?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::System.Collections.Generic.IList<global::Vellum.WorkflowEvent>).Name}");
