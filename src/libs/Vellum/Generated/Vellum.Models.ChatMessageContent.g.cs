...
namespace Vellum
{
    ...
    public readonly partial struct ChatMessageContent : global::System.IEquatable<ChatMessageContent>
    {
        ...
        public bool TryPickArrayChatMessageContent(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::Vellum.ArrayChatMessageContent? value)
        {
            value = ArrayChatMessageContent;
            return IsArrayChatMessageContent;
        }
        ...
        public global::Vellum.ArrayChatMessageContent PickArrayChatMessageContent() => IsArrayChatMessageContent
            ...
            : throw new global::System.InvalidOperationException($"Expected union variant 'ArrayChatMessageContent' but the value was {ToString()}.");
