...
namespace Vellum
{
    public partial class SubpackageDeploymentsClient
    {
        ...
        {
            var __response = await RetrievePromptDeploymentReleaseAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.PromptDeploymentRelease>> RetrievePromptDeploymentReleaseAsResponseAsync(
            string id,
            string releaseIdOrReleaseTag,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetrievePromptDeploymentRelease",
                                methodName: "RetrievePromptDeploymentReleaseAsync",
                                pathTemplate: "$\"/v1/deployments/{id}/releases/{releaseIdOrReleaseTag}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.PromptDeploymentRelease.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.PromptDeploymentRelease>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.PromptDeploymentRelease.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
