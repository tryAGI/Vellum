...
namespace Vellum
{
    public partial class SubpackageDocumentsClient
    {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.UploadDocumentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.UploadDocumentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.UploadDocumentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vellum.UploadDocumentResponse> UploadAsync(
            ...
            global::System.Collections.Generic.IList<string>? addToIndexNames = default,
            string? externalId = default,
            global::System.IO.Stream? contents = default,
            string? contentsname = default,
            string? url = default,
            global::System.Collections.Generic.IList<string>? keywords = default,
            byte[]? metadata = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Vellum.UploadRequest
            {
                AddToIndexNames = addToIndexNames,
                ExternalId = externalId,
                Label = label,
                Contents = global::System.Array.Empty<byte>(),
                Contentsname = contentsname,
                Url = url,
                Keywords = keywords,
                Metadata = metadata,
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (contents != default)
                            {
                                ...
                                var __contentContents = new global::System.Net.Http.StreamContent(contents);
                                __contentContents.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.Contentsname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.Contentsname) ?? string.Empty).ToLowerInvariant() switch
