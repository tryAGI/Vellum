...
namespace Vellum.JsonConverters
{
    ...
    public class TestSuiteRunExecConfigRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vellum.TestSuiteRunExecConfigRequest>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("data.prompt_sandbox_id")) __score1++;
            ...
            if (__jsonProps.Contains("data.history_item_id")) __score2++;
            if (__jsonProps.Contains("data.prompt_variant_id")) __score2++;
            if (__jsonProps.Contains("test_case_ids")) __score2++;
            if (__jsonProps.Contains("type")) __score2++;
            var __score3 = 0;
            if (__jsonProps.Contains("data")) __score3++;
            if (__jsonProps.Contains("data.tag")) __score3++;
            if (__jsonProps.Contains("data.workflow_deployment_id")) __score3++;
            if (__jsonProps.Contains("test_case_ids")) __score3++;
            if (__jsonProps.Contains("type")) __score3++;
            var __score4 = 0;
            if (__jsonProps.Contains("data")) __score4++;
            if (__jsonProps.Contains("data.workflow_sandbox_id")) __score4++;
            if (__jsonProps.Contains("test_case_ids")) __score4++;
            if (__jsonProps.Contains("type")) __score4++;
            var __score5 = 0;
            if (__jsonProps.Contains("data")) __score5++;
            if (__jsonProps.Contains("data.history_item_id")) __score5++;
            if (__jsonProps.Contains("data.workflow_variant_id")) __score5++;
            if (__jsonProps.Contains("test_case_ids")) __score5++;
            if (__jsonProps.Contains("type")) __score5++;
            var __score6 = 0;
            if (__jsonProps.Contains("data")) __score6++;
            if (__jsonProps.Contains("data.executions")) __score6++;
