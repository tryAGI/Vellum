...
namespace Vellum
{
    public partial class SandboxesClient
    {
        ...
        {
            var __response = await DeployPromptAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.DeploymentRead>> DeployPromptAsResponseAsync(
            global::System.Guid id,
            string promptVariantId,
