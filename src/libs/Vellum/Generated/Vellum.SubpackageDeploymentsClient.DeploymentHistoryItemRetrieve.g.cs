...
namespace Vellum
{
    public partial class SubpackageDeploymentsClient
    {
        ...
        partial void PrepareDeploymentHistoryItemRetrieveArguments(
            ...
            ref string id);
        partial void PrepareDeploymentHistoryItemRetrieveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid historyIdOrReleaseTag,
            string id);
        partial void ProcessDeploymentHistoryItemRetrieveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeploymentHistoryItemRetrieveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vellum.DeploymentHistoryItem> DeploymentHistoryItemRetrieveAsync(
            global::System.Guid historyIdOrReleaseTag,
            string id,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeploymentHistoryItemRetrieveAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.DeploymentHistoryItem>> DeploymentHistoryItemRetrieveAsResponseAsync(
            global::System.Guid historyIdOrReleaseTag,
            string id,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeploymentHistoryItemRetrieveArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeploymentHistoryItemRetrieveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeploymentHistoryItemRetrieve",
                                methodName: "DeploymentHistoryItemRetrieveAsync",
                                pathTemplate: "$\"/v1/deployments/{id}/history/{historyIdOrReleaseTag}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeploymentHistoryItemRetrieveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeploymentHistoryItemRetrieveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.DeploymentHistoryItem.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.DeploymentHistoryItem>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.DeploymentHistoryItem.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
