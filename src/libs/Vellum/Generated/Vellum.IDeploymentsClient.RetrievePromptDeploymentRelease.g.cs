...
namespace Vellum
{
    public partial interface IDeploymentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.PromptDeploymentRelease>> RetrievePromptDeploymentReleaseAsResponseAsync(
            string id,
            string releaseIdOrReleaseTag,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
