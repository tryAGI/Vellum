...
namespace Vellum
{
    public partial class SubpackageTestSuitesClient
    {
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement s_ListTestSuiteTestCasesSecurityRequirement0 =
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement[] s_ListTestSuiteTestCasesSecurityRequirements =
            new global::Vellum.EndPointSecurityRequirement[]
            {                s_ListTestSuiteTestCasesSecurityRequirement0,
            };
        partial void PrepareListTestSuiteTestCasesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref int? limit,
            ref int? offset);
        partial void PrepareListTestSuiteTestCasesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            int? limit,
            int? offset);
        partial void ProcessListTestSuiteTestCasesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListTestSuiteTestCasesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vellum.PaginatedTestSuiteTestCaseList> ListTestSuiteTestCasesAsync(
            string id,
            int? limit = default,
            int? offset = default,
        ...
        {
            var __response = await ListTestSuiteTestCasesAsResponseAsync(
                id: id,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.PaginatedTestSuiteTestCaseList>> ListTestSuiteTestCasesAsResponseAsync(
            string id,
            int? limit = default,
            int? offset = default,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListTestSuiteTestCasesArguments(
            ...
            var __authorizations = global::Vellum.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListTestSuiteTestCasesSecurityRequirements,
                operationName: "ListTestSuiteTestCasesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListTestSuiteTestCasesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListTestSuiteTestCasesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListTestSuiteTestCasesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.PaginatedTestSuiteTestCaseList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.PaginatedTestSuiteTestCaseList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.PaginatedTestSuiteTestCaseList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
