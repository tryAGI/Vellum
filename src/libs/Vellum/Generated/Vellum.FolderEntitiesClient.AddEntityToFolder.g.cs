...
namespace Vellum
{
    public partial class FolderEntitiesClient
    {
        ...
        {
            var __response = await AddEntityToFolderAsResponseAsync(
                folderId: folderId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.FolderEntitiesAddEntityToFolderResponse200>> AddEntityToFolderAsResponseAsync(
            string folderId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AddEntityToFolder",
                                methodName: "AddEntityToFolderAsync",
                                pathTemplate: "$\"/v1/folders/{folderId}/add-entity\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.FolderEntitiesAddEntityToFolderResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.FolderEntitiesAddEntityToFolderResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.FolderEntitiesAddEntityToFolderResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
