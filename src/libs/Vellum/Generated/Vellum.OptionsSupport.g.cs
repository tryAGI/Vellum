...
namespace Vellum
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Vellum.AutoSDKRetryOptions Retry { get; set; } = new global::Vellum.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Vellum.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Vellum.IAutoSDKHook>();
        ...
        public global::Vellum.AutoSDKClientOptions AddHook(
            global::Vellum.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Vellum.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Vellum.AutoSDKClientOptions UseAuthorizationProvider(
            global::Vellum.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Vellum.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Vellum.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Vellum.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Vellum.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Vellum.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Vellum.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Vellum.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Vellum.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Vellum.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Vellum.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Vellum.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Vellum.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Vellum.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Vellum.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Vellum.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Vellum.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Vellum.AutoSDKClientOptions clientOptions,
            global::Vellum.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Vellum.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Vellum.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Vellum.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Vellum.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Vellum.IAutoSDKHook, global::Vellum.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Vellum.AutoSDKHookContext context)
        {
