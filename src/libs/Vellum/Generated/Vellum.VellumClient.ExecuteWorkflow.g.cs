...
namespace Vellum
{
    public partial class VellumClient
    {
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement s_ExecuteWorkflowSecurityRequirement0 =
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement[] s_ExecuteWorkflowSecurityRequirements =
            new global::Vellum.EndPointSecurityRequirement[]
        ...
        {
            var __response = await ExecuteWorkflowAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.ExecuteWorkflowResponse>> ExecuteWorkflowAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "\"/v1/execute-workflow\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Vellum.ApiException<string>.Create(
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::Vellum.ApiException<global::Vellum.ExecuteWorkflowErrorResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.ExecuteWorkflowResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.ExecuteWorkflowResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.ExecuteWorkflowResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
