...
namespace Vellum
{
    public partial class SubpackageDeploymentsClient
    {
        ...
        {
            var __response = await ListDeploymentReleaseTagsAsResponseAsync(
                id: id,
                limit: limit,
                offset: offset,
                ordering: ordering,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.PaginatedDeploymentReleaseTagReadList>> ListDeploymentReleaseTagsAsResponseAsync(
            string id,
            int? limit = default,
            int? offset = default,
            string? ordering = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListDeploymentReleaseTags",
                                methodName: "ListDeploymentReleaseTagsAsync",
                                pathTemplate: "$\"/v1/deployments/{id}/release-tags\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.PaginatedDeploymentReleaseTagReadList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.PaginatedDeploymentReleaseTagReadList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.PaginatedDeploymentReleaseTagReadList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
