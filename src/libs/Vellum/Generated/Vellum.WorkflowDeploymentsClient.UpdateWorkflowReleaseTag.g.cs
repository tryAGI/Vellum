...
namespace Vellum
{
    public partial class WorkflowDeploymentsClient
    {
        ...
        {
            var __response = await UpdateWorkflowReleaseTagAsResponseAsync(
                id: id,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.WorkflowReleaseTagRead>> UpdateWorkflowReleaseTagAsResponseAsync(
            string id,
            string name,
