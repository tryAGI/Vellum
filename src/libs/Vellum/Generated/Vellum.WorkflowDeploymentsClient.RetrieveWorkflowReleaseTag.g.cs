...
namespace Vellum
{
    public partial class WorkflowDeploymentsClient
    {
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement s_RetrieveWorkflowReleaseTagSecurityRequirement0 =
        ...
        private static readonly global::Vellum.EndPointSecurityRequirement[] s_RetrieveWorkflowReleaseTagSecurityRequirements =
            new global::Vellum.EndPointSecurityRequirement[]
            {                s_RetrieveWorkflowReleaseTagSecurityRequirement0,
            };
        partial void PrepareRetrieveWorkflowReleaseTagArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string name);
        partial void PrepareRetrieveWorkflowReleaseTagRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string name);
        partial void ProcessRetrieveWorkflowReleaseTagResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetrieveWorkflowReleaseTagResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vellum.WorkflowReleaseTagRead> RetrieveWorkflowReleaseTagAsync(
            string id,
            string name,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RetrieveWorkflowReleaseTagAsResponseAsync(
                id: id,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.WorkflowReleaseTagRead>> RetrieveWorkflowReleaseTagAsResponseAsync(
            string id,
            string name,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveWorkflowReleaseTagArguments(
            ...
            var __authorizations = global::Vellum.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RetrieveWorkflowReleaseTagSecurityRequirements,
                operationName: "RetrieveWorkflowReleaseTagAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRetrieveWorkflowReleaseTagRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetrieveWorkflowReleaseTag",
                                methodName: "RetrieveWorkflowReleaseTagAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetrieveWorkflowReleaseTagResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetrieveWorkflowReleaseTagResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.WorkflowReleaseTagRead.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.WorkflowReleaseTagRead>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.WorkflowReleaseTagRead.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
