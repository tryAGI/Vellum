...
namespace Vellum
{
    ...
    public sealed partial class WorkflowExecutionActualStringRequest
    {
        ...
        public global::Vellum.StringEnum OutputType { get; set; }
        ...
        public string? DesiredOutputValue { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowExecutionActualStringRequest" /> class.
        /// </summary>
        /// <param name="outputId">
        /// The Vellum-generated ID of a workflow output. Must provide either this or output_key. output_key is typically preferred.
        /// </param>
...
#endif
        public WorkflowExecutionActualStringRequest(
            global::System.Guid? outputId,
            string? outputKey,
            double? quality,
            object? metadata,
            double? timestamp,
            global::Vellum.StringEnum outputType,
            string? desiredOutputValue)
        {
