...
namespace Vellum
{
    ...
    public sealed partial class SentenceChunkingRequest
    {
        ...
        public global::Vellum.SentenceChunkerConfigRequest? ChunkerConfig { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SentenceChunkingRequest" /> class.
        /// </summary>
...
#endif
        public SentenceChunkingRequest(
            global::Vellum.SentenceChunkerEnum chunkerName,
            global::Vellum.SentenceChunkerConfigRequest? chunkerConfig)
        {
