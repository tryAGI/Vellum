...
namespace Vellum.JsonConverters
{
    ...
    public class VellumWorkflowExecutionEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vellum.VellumWorkflowExecutionEvent>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("body.trigger")) __score0++;
            if (__jsonProps.Contains("body.workflow_definition")) __score0++;
            ...
            if (__jsonProps.Contains("body.workflow_definition")) __score1++;
            ...
            if (__jsonProps.Contains("body.final_state")) __score2++;
            if (__jsonProps.Contains("body.outputs")) __score2++;
            if (__jsonProps.Contains("body.redacted")) __score2++;
            if (__jsonProps.Contains("body.server_metadata")) __score2++;
            if (__jsonProps.Contains("body.workflow_definition")) __score2++;
            ...
            if (__jsonProps.Contains("body.workflow_definition")) __score3++;
            ...
            if (__jsonProps.Contains("body.external_inputs")) __score4++;
            if (__jsonProps.Contains("body.workflow_definition")) __score4++;
            ...
            if (__jsonProps.Contains("body.workflow_definition")) __score5++;
            ...
            if (__jsonProps.Contains("body.edited_by")) __score6++;
            if (__jsonProps.Contains("body.state")) __score6++;
            if (__jsonProps.Contains("body.workflow_definition")) __score6++;
