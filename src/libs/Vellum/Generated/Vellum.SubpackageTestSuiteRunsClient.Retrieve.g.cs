...
namespace Vellum
{
    public partial class SubpackageTestSuiteRunsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Vellum.TestSuiteRunRead> RetrieveAsync(
            global::System.Guid id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.TestSuiteRunRead>> RetrieveAsResponseAsync(
            global::System.Guid id,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/v1/test-suite-runs/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.TestSuiteRunRead.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.TestSuiteRunRead>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.TestSuiteRunRead.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
