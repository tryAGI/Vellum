...
namespace Vellum
{
    public partial interface ISubpackageTestSuitesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.PaginatedTestSuiteTestCaseList>> ListTestSuiteTestCasesAsResponseAsync(
            string id,
            int? limit = default,
            int? offset = default,
            global::Vellum.AutoSDKRequestOptions? requestOptions = default,
