...
{
    /// <inheritdoc />
    public class SearchResultMetaSourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vellum.SearchResultMetaSource>
    {
        /// <inheritdoc />
        public override global::Vellum.SearchResultMetaSource Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Vellum.PdfSearchResultMetaSource? pdfSearchResultMetaSource = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        pdfSearchResultMetaSource = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (pdfSearchResultMetaSource == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vellum.PdfSearchResultMetaSource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vellum.PdfSearchResultMetaSource> ??
            ...
            var __value = new global::Vellum.SearchResultMetaSource(
        ...
        public override void Write(
            ...
            global::Vellum.SearchResultMetaSource value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsPdfSearchResultMetaSource)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vellum.PdfSearchResultMetaSource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vellum.PdfSearchResultMetaSource?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Vellum.PdfSearchResultMetaSource).Name}");
