...
namespace Vellum
{
    public partial class WorkflowDeploymentsClient
    {
        ...
        {
            var __response = await ListWorkflowDeploymentEventExecutionsAsResponseAsync(
                id: id,
                filters: filters,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vellum.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vellum.AutoSDKHttpResponse<global::Vellum.WorkflowDeploymentEventExecutionsResponse>> ListWorkflowDeploymentEventExecutionsAsResponseAsync(
            string id,
            string? filters = default,
            int? limit = default,
            int? offset = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vellum.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListWorkflowDeploymentEventExecutions",
                                methodName: "ListWorkflowDeploymentEventExecutionsAsync",
                                pathTemplate: "$\"/v1/workflow-deployments/{id}/execution-events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Vellum.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vellum.WorkflowDeploymentEventExecutionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vellum.AutoSDKHttpResponse<global::Vellum.WorkflowDeploymentEventExecutionsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vellum.WorkflowDeploymentEventExecutionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
